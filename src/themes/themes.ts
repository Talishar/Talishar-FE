...
export const themes: Theme[] = [
  ...
  },
  {
    ...
    colors: {
      ...
      primaryHover: '#9d88c8',
      primaryFocus: 'rgba(125, 79, 184, 0.125)',
      ...
      border: 'rgba(125, 79, 184, 0.25)',
      borderLight: 'rgba(125, 79, 184, 0.12)',
      ...
      dropdownHoverBackground: 'rgba(125, 79, 184, 0.12)',
  ...
  },
  {
    ...
    colors: {
      ...
      primaryHover: '#d87a8d',
      primaryFocus: 'rgba(200, 90, 109, 0.125)',
      ...
      border: 'rgba(200, 90, 109, 0.2)',
      borderLight: 'rgba(200, 90, 109, 0.1)',
      ...
      dropdownHoverBackground: 'rgba(200, 90, 109, 0.1)',
  ...
  },
  {
    ...
    colors: {
      ...
      primaryHover: '#52d489',
      primaryFocus: 'rgba(46, 204, 113, 0.125)',
      ...
      borderLight: 'rgba(46, 204, 113, 0.18)',
      ...
      dropdownHoverBackground: 'rgba(46, 204, 113, 0.18)',
