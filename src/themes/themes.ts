...
export const themes: Theme[] = [
  {
    ...
    colors: {
      ...
      sectionBackground:
        'linear-gradient(135deg, rgba(30, 35, 41, 0.8) 0%, rgba(26, 31, 38, 0.9) 100%)',
  ...
  },
  {
    ...
    colors: {
      ...
      sectionBackground:
        'linear-gradient(135deg, rgba(58, 58, 58, 0.85) 0%, rgba(45, 45, 45, 0.9) 100%)',
  ...
  },
  {
    ...
    colors: {
      ...
      sectionBackground:
        'linear-gradient(135deg, rgba(26, 31, 58, 0.8) 0%, rgba(18, 22, 42, 0.9) 100%)',
  ...
  },
  {
    ...
    colors: {
      ...
      sectionBackground:
        'linear-gradient(135deg, rgba(26, 18, 37, 0.9) 0%, rgba(15, 10, 21, 0.95) 100%)',
  ...
  },
  {
    ...
    colors: {
      ...
      sectionBackground:
        'linear-gradient(135deg, rgba(26, 21, 21, 0.85) 0%, rgba(18, 12, 12, 0.95) 100%)',
  ...
  },
  {
    ...
    colors: {
      ...
      sectionBackground:
        'linear-gradient(135deg, rgba(26, 33, 32, 0.85) 0%, rgba(13, 20, 16, 0.95) 100%)',
  ...
  },
  {
    ...
    colors: {
      ...
      sectionBackground:
        'linear-gradient(135deg, rgba(30, 20, 31, 0.85) 0%, rgba(17, 9, 20, 0.95) 100%)',
  ...
  },
  {
    ...
    colors: {
      ...
      sectionBackground:
        'linear-gradient(135deg, rgba(32, 26, 21, 0.85) 0%, rgba(22, 16, 11, 0.95) 100%)',
  ...
  },
  {
    ...
    colors: {
      ...
      sectionBackground:
        'linear-gradient(135deg, rgba(26, 31, 46, 0.85) 0%, rgba(15, 20, 25, 0.95) 100%)',
  ...
  },
  {
    ...
    colors: {
      ...
      sectionBackground:
        'linear-gradient(135deg, rgba(31, 35, 43, 0.85) 0%, rgba(10, 14, 18, 0.95) 100%)',
  ...
  },
  {
    ...
    colors: {
      ...
      sectionBackground:
        'linear-gradient(135deg, rgba(19, 29, 42, 0.85) 0%, rgba(10, 15, 26, 0.95) 100%)',
  ...
  },
  {
    ...
    colors: {
      ...
      sectionBackground:
        'linear-gradient(135deg, rgba(33, 26, 15, 0.85) 0%, rgba(21, 16, 10, 0.95) 100%)',
...
export const getThemeById = (id: string, transparency = 0.98): Theme => {
