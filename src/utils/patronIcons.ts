...
export const createPatreonIconMap = (
  ...
  // Check if user has Talishar-specific Metafy badges (not from other creators)
  ...
  // Only add Talishar patron badges if user doesn't have Talishar-specific Metafy badges
