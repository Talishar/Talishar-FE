...
{/*           <p className={styles.fieldError}>
        ...
        <a
          href={`https://metafy.gg/auth/authorize?client_id=${import.meta.env.VITE_METAFY_CLIENT_ID || ''}&redirect_uri=${encodeURIComponent('https://talishar.net/AccountFiles/MetafySignupAPI.php')}&response_type=code&scope=profile`}
