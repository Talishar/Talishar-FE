...
<a
  href={`https://metafy.gg/auth/authorize?client_id=${(import.meta as any).env?.VITE_METAFY_LOGIN_CLIENT_ID || ''}&redirect_uri=${encodeURIComponent('https://talishar.net/auth/metafy-signup')}&response_type=code&scope=profile`}
...
>
  ...
  Login with Metafy (Under development, do not use except for development testing!)
</a>
<hr className={styles.divider} />
