  ...
  return (
    <div>
      ...
      <article className={styles.formContainer}>
        ...
        className="outline"
        style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5em', marginTop: '18px', width: '100%', background: 'transparent', color: 'var(--theme-primary)' }}
      >
