    ...
    <div>
      <article className={styles.formContainer}>
        ...
        <p className={styles.fieldError}>
          <FaExclamationCircle /> Warning - In 1h at 11:15 AM CET an update will be pushed to the live servers. The games in progress will crash and new games will be required.
          </p>
        <p>
