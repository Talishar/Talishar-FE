          ...
          <div className={styles.rightCol}>
            <div className={styles.navRow}>
              ...
              <nav
                ...
                aria-label={t('FOOTER.USER_LINKS_LABEL')}
              >
                <Link to="/user">
                  <BsPersonFill aria-hidden="true" /> {t('HEADER.PROFILE')}
                </Link>
                <Link to="/user/settings">
                  <BsGearFill aria-hidden="true" /> {t('HEADER.SETTINGS')}
                </Link>
              </nav>
            </div>
            ...
            <nav
              ...
              aria-label={t('FOOTER.SOCIAL_LINKS_LABEL')}
            >
              <a
                href={TALISHAR_GITHUB_URL}
                target="_blank"
                rel="noopener noreferrer"
                aria-label={t('FOOTER.SOCIAL_GITHUB')}
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label={t('FOOTER.SOCIAL_BLUESKY')}
              >
                <svg
                  width="1em"
                  height="1em"
            ...
            <nav
              ...
              aria-label={t('FOOTER.LEGAL_LINKS_LABEL')}
            >
